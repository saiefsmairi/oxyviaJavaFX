...
public class DashboardController implements Initializable {
    ...
    @FXML
    private void goreservation(MouseEvent event) throws IOException {
       
         try {
            Parent parent = FXMLLoader.load(getClass().getResource("GestionRes.fxml"));
            Scene scene = new Scene(parent);
            Stage stage = new Stage();
            stage.setScene(scene);
            stage.initStyle(StageStyle.UTILITY);
    ...
    @FXML
    private void govoyage(MouseEvent event) {
    }
